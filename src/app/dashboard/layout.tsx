...
import { Activity, BarChart3, Home, Settings, Users } from "lucide-react"
        ...
        <Sidebar>
          ...
          <SidebarContent>
            <SidebarMenu>
              ...
              <SidebarMenuButton asChild>
                <a href="/dashboard/patients" tooltip="Patients">
                  <Users />
                  <span>Patients</span>
                </a>
              </SidebarMenuButton>
              <SidebarMenuButton asChild>
                <a href="/dashboard/follow-ups" tooltip="Follow-ups">
                  <Activity />
                  <span>Follow-ups</span>
                </a>
              </SidebarMenuButton>
              <SidebarMenuButton asChild>
                <a href="/dashboard/settings" tooltip="Settings">
                  <Settings />
                  <span>Settings</span>
                </a>
              </SidebarMenuButton>
